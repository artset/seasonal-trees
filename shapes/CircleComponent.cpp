...
//            t2.getTriangleData(triangles);
            ...
            // primitive type could also be cylinder, or even cube
            setTriangleVertexData(PrimitiveType::PRIMITIVE_CONE, m_transformation, { v2, n0 }, { v1, n0 }, { v0, n0 });
            setTriangleVertexData(PrimitiveType::PRIMITIVE_CONE, m_transformation, { v3, n1 }, { v1, n1 }, { v2, n1 });
        }
    }
...
//    t1.getTriangleData(vertexData);
    setTriangleVertexData(PrimitiveType::PRIMITIVE_CONE, m_transformation, { v0, n }, { v2, n }, { v1, n });
}
