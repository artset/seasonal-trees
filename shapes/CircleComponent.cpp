...
//            t2.getTriangleData(triangles);
            ...
            Utilities::setTriangleVertexData(m_vertexData, PrimitiveType::PRIMITIVE_CYLINDER, m_transformation, { v1, n1 }, { v2, n1 }, { v3, n1 });
        }
    }
...
//    t1.getTriangleData(vertexData);
    Utilities::setTriangleVertexData(m_vertexData, PrimitiveType::PRIMITIVE_CYLINDER, m_transformation, { v2, n }, { v1, n }, { v0, n });
}
