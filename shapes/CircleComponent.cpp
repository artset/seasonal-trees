...
//            t2.getTriangleData(triangles);
            ...
            setTriangleVertexData(PrimitiveType::PRIMITIVE_CONE, { v2, n0 }, { v1, n0 }, { v0, n0 });
            setTriangleVertexData(PrimitiveType::PRIMITIVE_CONE, { v3, n1 }, { v1, n1 }, { v2, n1 });
        }
    }
...
//    t1.getTriangleData(vertexData);
    setTriangleVertexData(PrimitiveType::PRIMITIVE_CONE, { v0, n }, { v2, n }, { v1, n });
}
